...
use Purwantoid\LaravelPackage\Commands\Concerns;
...
In your package you should let your service provider extend `Purwantoid\LaravelPackage\PackageServiceProvider`.
